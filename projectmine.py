...
class StartPage(tk.Frame):
    ...
    def __init__(self,parent,controller):
        ...
        self.controller.title('airline')
        self.controller.state('zoomed')
        load = Image.open("20210118_205927.jpg")
        ...
        t2=tk.Entry(self, font=('bahnschrift',15),show="*",width=15)
        ...
        def register():
            ...
            window.mainloop()
        ls_btn=tk.Button(self,text="Sign Up",font=('bahnschrift',15),command=register,fg="#000000",bg='white',padx=1)
        ls_btn.place(x=1450,y=0)
...
class Homepage(tk.Frame):
    ...
    def __init__(self,parent,controller):
        ...
        fs_btn=tk.Button(self,text="Add Flight Coordinators",font=('bahnschrift',15),bg='#1a1a1a',fg='white',command=lambda: controller.show_frame(flightschedulepage),relief='raised',borderwidth=2,width=40,height=5)
        fs_btn.place(x=200,y=100)
        fa_btn=tk.Button(self,text="Add Flight Schedules ",font=('bahnschrift',15),bg='#1a1a1a',fg='white',command=lambda: controller.show_frame(flightsarrival),relief='raised',borderwidth=2,width=40,height=5)
        fa_btn.place(x=200,y=250)
        cr_btn=tk.Button(self,text="Report Flight Departures",font=('bahnschrift',15),bg='#1a1a1a',fg='white',command=lambda: controller.show_frame(flapage),relief='raised',borderwidth=2,width=40,height=5)
        cr_btn.place(x=200,y=400)
        cr1_btn=tk.Button(self,text="Assign Crew ",font=('bahnschrift',15),bg='#1a1a1a',fg='white',command=lambda: controller.show_frame(mypage),relief='raised',borderwidth=2,width=40,height=5)
        cr1_btn.place(x=800,y=100)
        cr2_btn=tk.Button(self,text="Update Flight Arrivals",font=('bahnschrift',15),bg='#1a1a1a',fg='white',command=lambda: controller.show_frame(lastpage),relief='raised',borderwidth=2,width=40,height=5)
        cr2_btn.place(x=800,y=250)
        cr3_btn=tk.Button(self,text="View Cancelled Flights",font=('bahnschrift',15),bg='#1a1a1a',fg='white',command=lambda: controller.show_frame(cancelledpage),relief='raised',borderwidth=2,width=40,height=5)
        cr3_btn.place(x=800,y=400)
        cr4_btn=tk.Button(self,text="Exit",font=('bahnschrift',15),bg='#1a1a1a',fg='white',command=lambda: controller.show_frame(StartPage),relief='raised',width=40,height=5)
        cr4_btn.place(x=500,y=600)
...
class flightschedulepage(tk.Frame):
    ...
    def __init__(self,parent,controller):
        ...
        RightFrame.place(x=600,y=100,width=560,height=370)
        
        BottomFrame=tk.Frame(self,bd=0,relief='ridge',bg="#000000")
        BottomFrame.place(x=100,y=450,width=110,height=50)
        ...
        BottomFrame2.place(x=200,y=550,width=120,height=50)
        BottomFrame3=tk.Frame(self,bd=0,relief='ridge',bg="#000000")
        BottomFrame3.place(x=300,y=450,width=110,height=50)
        ...
        BottomFrame5.place(x=0,y=750,width=150,height=50)
        
        #main_la=tk.Label(LeftFrame,font=('bahnschrift',20),text='Flight Schedule Details')
        #main_la.grid()
        co_no =tk.Label(self, font=('bahnschrift',15),text="Coordinator id:",fg='white',bg='#000000')
        co_no.place(x=100,y=100)
        co_no_en =tk.Entry(self, font=('bahnschrift',15),width =15)
        co_no_en.place(x=250,y=100)
        co_fna=tk.Label(self, font=('bahnschrift',15),text="First Name:",fg="white",bg="#000000",padx=1)
        co_fna.place(x=100,y=150)
        co_fna_en=tk.Entry(self, font=('bahnschrift',15),width=15)
        co_fna_en.place(x=250,y=150)
        co_lna=tk.Label(self,font=('bahnnschrift',15),text="Last Name:",fg='white',bg='#000000',padx=1)
        co_lna.place(x=100,y=200)
        co_lna_en=tk.Entry(self, font=('bahnschrift',15),width=15)
        co_lna_en.place(x=250,y=200)
        co_cno=tk.Label(self,font=('bahnnschrift',15),text="Contact No:",fg='white',bg='#000000',padx=1)
        co_cno.place(x=100,y=250)
        co_cno_en=tk.Entry(self, font=('bahnschrift',15),width=15)
        co_cno_en.place(x=250,y=250)
        co_age=tk.Label(self,font=('bahnnschrift',15),text="Age:",fg='white',bg='#000000',padx=1)
        co_age.place(x=100,y=300)
        co_age_en=tk.Entry(self, font=('bahnschrift',15),width=15)
        co_age_en.place(x=250,y=300)
        co_email=tk.Label(self,font=('bahnnschrift',15),text="Email id:",fg='white',bg='#000000',padx=1)
        co_email.place(x=100,y=350)
        co_email_en=tk.Entry(self, font=('bahnschrift',15),width=15)
        co_email_en.place(x=250,y=350)
        ...
        fs_btn=tk.Button(BottomFrame5,text="<-prev",font=('bahnschrift',22),command=lambda: controller.show_frame(Homepage),fg="#000000",bg='white',padx=1)
        ...
        d_btn=tk.Button(BottomFrame2,font=('bahnschrift',22),text='View',command=viewData,fg='#000000',bg='white',padx=2)
...
class flightsarrival(tk.Frame):
    ...
    def __init__(self,parent,controller):
        ...
        BottomFrame1.place(x=400,y=550,width=150,height=50)
        BottomFrame2=tk.Frame(self,bd=0,relief='ridge',bg="#000000")
        BottomFrame2.place(x=800,y=500,width=150,height=50)
        BottomFrame3=tk.Frame(self,bd=0,relief='ridge',bg="#000000")
        BottomFrame3.place(x=300,y=650,width=150,height=50)
        #BottomFrame4=tk.Frame(self,bd=0,relief='ridge',bg="#000000")
        #BottomFrame4.place(x=1000,y=550,width=150,height=50)
        BottomFrame5=tk.Frame(self,bd=0,relief='ridge',bg="#000000")
        BottomFrame5.place(x=1440,y=0,width=150,height=50)
        #BottomFrame6=tk.Frame(self,bd=0,relief='ridge',bg="#000000")
        #BottomFrame6.place(x=1200,y=550,width=150,height=50)
...
class flapage(tk.Frame):
    ...
    def __init__(self,parent,controller):
        ...
        BottomFrame=tk.Frame(self,bd=0,relief='ridge',bg="#000000")
        BottomFrame.place(x=100,y=500,width=150,height=50)
        BottomFrame1=tk.Frame(self,bd=0,relief='ridge',bg="#000000")
        BottomFrame1.place(x=400,y=550,width=150,height=50)
        BottomFrame2=tk.Frame(self,bd=0,relief='ridge',bg="#000000")
        BottomFrame2.place(x=200,y=600,width=150,height=50)
        BottomFrame3=tk.Frame(self,bd=0,relief='ridge',bg="#000000")
        BottomFrame3.place(x=300,y=500,width=150,height=50)
        BottomFrame4=tk.Frame(self,bd=0,relief='ridge',bg="#000000")
        BottomFrame4.place(x=1000,y=550,width=150,height=50)
        BottomFrame5=tk.Frame(self,bd=0,relief='ridge',bg="#000000")
        BottomFrame5.place(x=0,y=750,width=150,height=50)
        BottomFrame6=tk.Frame(self,bd=0,relief='ridge',bg="#000000")
        BottomFrame6.place(x=450,y=800,width=150,height=50)
        ...
        fl_ty=tk.Label(LeftFrame,font=('bahnnschrift',15),text="Flight Type:",fg='white',bg='#000000',padx=1)
        fl_ty.grid(row=5,column=0)
        fl_ty_en=tk.Entry(LeftFrame, font=('bahnschrift',15),width=15)
        fl_ty_en.grid(row=5,column=1,pady=6, padx=20)
        fl_de=tk.Label(LeftFrame,font=('bahnnschrift',15),text="Flight Destination:",fg='white',bg='#000000',padx=1)
        fl_de.grid(row=7,column=0)
        fl_de_en=tk.Entry(LeftFrame, font=('bahnschrift',15),width=15)
        fl_de_en.grid(row=7,column=1,pady=6, padx=20)
        fl_deti=tk.Label(LeftFrame,font=('bahnnschrift',15),text="Flight departure time:",fg='white',bg='#000000',padx=1)
        fl_deti.grid(row=9,column=0)
        fl_deti_en=tk.Entry(LeftFrame, font=('bahnschrift',15),width=15)
        fl_deti_en.grid(row=9,column=1,pady=6, padx=20)
        fl_co=tk.Label(LeftFrame,font=('bahnnschrift',15),text="Assigned by:",fg='white',bg='#000000',padx=1)
        fl_co.grid(row=12,column=0)
        fl_co_en=tk.Entry(LeftFrame, font=('bahnschrift',15),width=15)
        fl_co_en.grid(row=12,column=1,pady=6, padx=20)
        ...
        def reset():
            fl_no_en.delete(0,'end')
            fl_na_en.delete(0,'end')
            fl_ty_en.delete(0,'end')
            fl_de_en.delete(0,'end')
            fl_deti_en.delete(0,'end')
            fl_co_en.delete(0,'end')
        #l_btn=tk.Button(BottomFrame6,font=('bahnschrift',22),text='Reset',command=reset,fg='#000000',bg='white',padx=2)
        #l_btn.grid(row=2,column=1)
        ...
        def selected(event):
            ...
            fl_ty_en.insert(2,r[2])
            fl_de_en.insert(3,r[3])
            
            
            fl_deti_en.insert(4,r[4])
           
            fl_co_en.insert(5,r[5])
        ...
        d_btn=tk.Button(BottomFrame2,font=('bahnschrift',22),text='View All',command=viewData,fg='#000000',bg='white',padx=2)
        d_btn.grid(row=11,column=0)
        def searchDatabase():
            airlinelist.delete(*airlinelist.get_children())
            for row in searchData(fl_no_en.get(),fl_na_en.get(),fl_ty_en.get(),fl_de_en.get(),fl_deti_en.get(),fl_co_en.get()):
                airlinelist.insert('','end',value=row)
...
class mypage(tk.Frame):
    ...
    def __init__(self,parent,controller):
        ...
        #main_la=tk.Label(LeftFrame,font=('bahnschrift',20),text='Flight Schedule Details')
        #main_la.grid()
        cr_no =tk.Label(LeftFrame, font=('bahnschrift',15),text="Crew No:",fg='white',bg='#000000')
        cr_no.grid(row=1,column=0)
        cr_no_en =tk.Entry(LeftFrame, font=('bahnschrift',15),width =15)
        cr_no_en.grid(row=1,column=1,padx=6,pady=20)
        cr_na=tk.Label(LeftFrame, font=('bahnschrift',15),text="Crew Name:",fg="white",bg="#000000",padx=1)
        cr_na.grid(row=3,column=0)
        cr_na_en=tk.Entry(LeftFrame, font=('bahnschrift',15),width=15)
        cr_na_en.grid(row=3,column=1,pady=6, padx=20)
        cr_age=tk.Label(LeftFrame,font=('bahnnschrift',15),text="Crew Age:",fg='white',bg='#000000',padx=1)
        cr_age.grid(row=5,column=0)
        cr_age_en=tk.Entry(LeftFrame, font=('bahnschrift',15),width=15)
        cr_age_en.grid(row=5,column=1,pady=6, padx=20)
        cr_role=tk.Label(LeftFrame,font=('bahnnschrift',15),text="Job Role:",fg='white',bg='#000000',padx=1)
        cr_role.grid(row=7,column=0)
        cr_role_en=tk.Entry(LeftFrame, font=('bahnschrift',15),width=15)
        cr_role_en.grid(row=7,column=1,pady=6, padx=20)
        cr_cont=tk.Label(LeftFrame,font=('bahnnschrift',15),text="Contact No:",fg='white',bg='#000000',padx=1)
        cr_cont.grid(row=9,column=0)
        cr_cont_en=tk.Entry(LeftFrame, font=('bahnschrift',15),width=15)
        cr_cont_en.grid(row=9,column=1,pady=6, padx=20)
        cr_assf=tk.Label(LeftFrame,font=('bahnnschrift',15),text="Assigned Flight:",fg='white',bg='#000000',padx=1)
        cr_assf.grid(row=12,column=0)
        cr_assf_en=tk.Entry(LeftFrame, font=('bahnschrift',15),width=15)
        cr_assf_en.grid(row=12,column=1,pady=6, padx=20)
        
        cr_co=tk.Label(LeftFrame,font=('bahnnschrift',15),text="Assigned by:",fg='white',bg='#000000',padx=1)
        cr_co.grid(row=13,column=0)
        cr_co_en=tk.Entry(LeftFrame, font=('bahnschrift',15),width=15)
        cr_co_en.grid(row=13,column=1,pady=6, padx=20)
        
        def submit():
            conn=sqlite3.connect('b.db')
            c=conn.cursor()
            c.execute("INSERT INTO CREW VALUES(:f_no,:f_na,:f_da,:f_ti,:f_so,:f_de,:fc)",
                      {
                             'f_no':cr_no_en.get(),
                             'f_na':cr_na_en.get(),
                             'f_da':cr_age_en.get(),
        ...
        s_btn.grid(row=2,column=1)
        def reset():
            cr_no_en.delete(0,'end')
            cr_na_en.delete(0,'end')
            cr_age_en.delete(0,'end')
            cr_role_en.delete(0,'end')
            cr_cont_en.delete(0,'end')
            cr_assf_en.delete(0,'end')
            cr_co_en.delete(0,'end')
        #l_btn=tk.Button(BottomFrame6,font=('bahnschrift',22),text='Reset',command=reset,fg='#000000',bg='white',padx=2)
        #l_btn.grid(row=2,column=1)
        ...
        def selected(event):
            ...
            cr_no_en.insert(0,r[0])
           
          
            cr_na_en.insert(1,r[1])
           
            cr_age_en.insert(2,r[2])
            cr_role_en.insert(3,r[3])
            
            
            cr_cont_en.insert(4,r[4])
            cr_assf_en.insert(5,r[5])
            
           
            cr_co_en.insert(6,r[6])
        ...
        airlinelist.heading("cocono",text="Role")
        airlinelist.heading("coag",text="Cont No")
        ...
        def searchDatabase():
            airlinelist.delete(*airlinelist.get_children())
            for row in searchData(cr_no_en.get(),cr_na_en.get(),cr_age_en.get(),cr_role_en.get(),cr_cont_en.get(),cr_assf_en.get(),cr_co_en.get()):
                airlinelist.insert('','end',value=row)
        ...
        def update():
            ...
            conn=sqlite3.connect('b.db')
            c=conn.cursor()
            c.execute("UPDATE CREW SET CREW_NAME=?, CREW_AGE=?, CREW_ROLE=?, CREW_CN=?,ASS_F=?, ASS_COID=?  WHERE CREW_ID=?",(a,m,e,s,l,i,n))
            conn.commit()
            conn.close()
            reset()
            viewData()
...
class cancelledpage(tk.Frame):
    ...
    def __init__(self,parent,controller):
        ...
        label2.pack()
        RightFrame=tk.Frame(self,bd=1,relief='ridge',bg="white")
        RightFrame.place(x=500,y=100,width=650,height=370)
        scrollbar= tk.Scrollbar(RightFrame)
        scrollbar.grid(row=0, column=1,sticky='ns')
        ...
        airlinelist= ttk.Treeview(RightFrame, height=16,column=("coid","cofna","colna","cocono","coag","coass","cocoid"), yscrollcommand=scrollbar.set )
        ...
        airlinelist.heading("cocoid",text="Coordinator ID")
        ...
        airlinelist.column("coag",width=90)
        airlinelist.column("coass",width=90)
        airlinelist.column("cocoid",width=90)
        ...
        def viewData():
            con = sqlite3.connect("b.db")
            cur = con.cursor()
            cur.execute("SELECT * FROM DELETED_FLIGHT")
            row =cur.fetchall()
            airlinelist.delete(*airlinelist.get_children())
            if len(row)!=0:
                        for num in row:
